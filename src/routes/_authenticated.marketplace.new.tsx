...
import { PRODUCT_TYPES, type ProductType } from "@/lib/product-catalog";
        ...
        >
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Ex : Guide Bali secret"
              maxLength={120}
              required
            />
          </div>
          ...
          <Button
            ...
            className="w-full rounded-full gradient-hero text-primary-foreground shadow-soft"
          >
            {submit.isPending ? "Publication…" : "Publier le produit"}
          </Button>
          <p className="text-center text-[11px] text-muted-foreground">
            Le paiement intégré arrive bientôt. Pour l'instant, contact et livraison se font en
            messagerie.
          </p>
        </form>
      </main>
