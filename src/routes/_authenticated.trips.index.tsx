        ...
        <div className="flex items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              Tes carnets de route : cartes, photos, dépenses et souvenirs.
            </p>
          </div>
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
              ...
              <DialogFooter>
                <Button
                  disabled={!form.country || create.isPending}
        ...
        <div className="mt-8">
          {isLoading ? (
              ...
              {trips.map((t) => (
                ...
                >
                  <div className="relative aspect-[4/3] bg-muted">
                    ...
                    />
                    <span className="absolute right-3 top-3 rounded-full bg-background/80 px-2 py-1 text-xs font-medium backdrop-blur">
                      {t.status ?? "planned"}
                    </span>
                  </div>
                  <div className="p-4">
                    ...
                    <div className="mt-3 flex items-center gap-3 text-xs text-muted-foreground">
                      ...
                      {t.starts_on && (
                        <span className="flex items-center gap-1">
                          <Calendar className="h-3 w-3" /> {t.starts_on}
                        </span>
                      )}
                    </div>
                  </div>
            ...
            <div className="rounded-3xl border border-dashed border-border p-12 text-center text-muted-foreground">
              ...
              Ton carnet est vide. Crée ton premier voyage ou{" "}
              <Link to="/ai-trip" className="text-accent underline">
                prépare-en un avec le conseiller
              </Link>
              .
            </div>
          )}
