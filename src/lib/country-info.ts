...
// Repères éditoriaux statiques utilisés lorsque le pays ne fournit pas encore de fiche communautaire.
...
export const COUNTRY_INFO: CountryInfo[] = [
  {
    ...
    gallery: [
      ...
      img("photo-1524413840807-0c3cb6fa808d"),
    ...
    activities: [
      ...
      "Mont Fuji au lever",
      "Onsen à Hakone",
      "Tsukiji au petit-matin",
    ],
    tags: ["Culture", "Gastronomie", "Nature", "Ville"],
    currency: "JPY",
    language: "Japonais",
    intro:
      "Néons de Tokyo, temples de Kyoto, ryokans thermaux et montagnes sacrées : un choc culturel doux et fascinant.",
  },
  {
    code: "id",
    name: "Indonésie",
    ...
    gallery: [
      ...
      img("photo-1518623489648-a173ef7824f3"),
    ],
    ...
    activities: [
      ...
      "Rizières de Ubud",
      "Plongée à Komodo",
      "Lever de soleil sur Mont Batur",
    ],
    tags: ["Plages", "Plongée", "Spiritualité", "Backpacker"],
    currency: "IDR",
    language: "Indonésien",
    intro:
      "Bali, Lombok, Java, Sumatra : plus de 17 000 îles entre rizières, volcans et récifs coralliens.",
  },
  {
    code: "fr",
    name: "France",
    ...
    gallery: [
      ...
      img("photo-1522093537031-3ee69e6b1746"),
  ...
  },
  {
    ...
    gallery: [
      ...
      img("photo-1523906630133-f6934a1ab2b9"),
    ...
    language: "Italien",
    intro:
      "Pâtes, ruines, îles turquoise et villages perchés : la dolce vita à toutes les échelles.",
  },
  {
    code: "th",
    name: "Thaïlande",
    ...
    language: "Thaï",
    intro:
      "Bangkok trépidante, plages du sud, temples du nord et nourriture inoubliable pour presque rien.",
  },
  {
    code: "us",
    name: "États-Unis",
    ...
    language: "Anglais",
    intro:
      "Un continent : mégapoles électriques, parcs nationaux immenses et road trips mythiques.",
  },
  {
    code: "es",
    name: "Espagne",
    ...
    gallery: [
      img("photo-1509840841025-9088ba78a826"),
      img("photo-1509604931938-5b0e3d17d29d"),
      img("photo-1522602573003-b7dc9ba5f5e2"),
      img("photo-1522093007474-d86e9bf7ba6f"),
    ],
  ...
  },
  {
    ...
    gallery: [
      ...
      img("photo-1544015759-62db6a9bd3d8"),
      img("photo-1508515053963-70c7cc39dfb5"),
    ],
    ...
    language: "Portugais",
    intro:
      "Azulejos, fado, océan Atlantique, vin de Porto et un rapport qualité-prix imbattable en Europe.",
  },
  {
    code: "mx",
    name: "Mexique",
    ...
    gallery: [
      img("photo-1512813498716-3e640fed3f39"),
      img("photo-1518709911915-712d5fd04677"),
      img("photo-1526481280695-3c469b57e2b1"),
      img("photo-1533106418989-88406c7cc8ca"),
    ],
    ...
    language: "Espagnol",
    intro:
      "Pyramides mayas, cénotes turquoise, désert, jungle et l'une des meilleures cuisines du monde.",
  },
  {
    code: "gr",
    name: "Grèce",
    ...
    gallery: [
      ...
      img("photo-1580500550469-4e1a1e26acdc"),
      img("photo-1509233725247-49e657c54213"),
    ],
    bestTime: "Mai-Juin · Septembre",
    costPerDay: "80-140 €",
  ...
  },
  {
    ...
    gallery: [
      img("photo-1531168556467-80aace0d0144"),
      img("photo-1502786129293-79981df4e689"),
      img("photo-1520080591444-3e1af0d3e4b6"),
      img("photo-1490806843957-31f4c9a91c65"),
    ],
    ...
    activities: [
      ...
      "Glaciers du sud",
      "Blue Lagoon",
      "Trek à Landmannalaugar",
    ],
    tags: ["Nature", "Aurores", "Volcans", "Cascades"],
    currency: "ISK",
    language: "Islandais",
    intro:
      "Volcans, glaciers, geysers et aurores boréales — un décor lunaire sur une île préservée.",
  },
];
