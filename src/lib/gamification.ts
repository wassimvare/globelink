...
export const BADGES: BadgeDef[] = [
  {
    ...
    description: "Créer ton tout premier carnet",
    emoji: "🧳",
    target: 1,
    metric: "trips",
  },
  {
    key: "five_countries",
    label: "5 pays",
    description: "Explorer 5 pays différents",
    emoji: "🗺️",
    target: 5,
    metric: "countries",
  },
  {
    key: "ten_countries",
    label: "10 pays",
    description: "Explorer 10 pays différents",
    emoji: "🌐",
    target: 10,
    metric: "countries",
  },
  ...
  },
  {
    key: "thousand_likes",
    label: "1 000 likes",
    description: "Cumuler 1 000 likes",
    emoji: "❤️",
    target: 1000,
    metric: "likes",
  },
  {
    ...
    description: "Cumuler 100 km sur tes carnets",
    emoji: "🛤️",
    target: 100,
    metric: "distanceKm",
  },
  {
    key: "tenk_km",
    label: "10 000 km parcourus",
    description: "Cumuler 10 000 km",
    emoji: "✈️",
    target: 10000,
    metric: "distanceKm",
  },
  {
    ...
    description: "Ouvrir ton premier carnet",
    emoji: "📓",
    target: 1,
    metric: "trips",
  },
  {
    key: "first_reel",
    label: "Premier Reel",
    description: "Publier ton premier Reel",
    emoji: "🎬",
    target: 1,
    metric: "reels",
  },
